// Server entry (`@oxyhq/pay`) — the merchant-authed SDK. Configured with a
...
import { resolveConfig, type OxyPayConfig } from './core/config';
...
export class OxyPay {
  ...
  constructor(config: OxyPayConfig) {
...
export type { OxyPayConfig, ResolvedOxyPayConfig } from './core/config';
...
export type { OxyPayErrorType, OxyPayErrorDetails } from './core/errors';
